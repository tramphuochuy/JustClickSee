...
namespace GB
{
    ...
    public partial class ChatItem_Files : UserControl
    {
        public int ID = 0;
        public string Text = "";
        public string Head = "";
        ...
        public ChatItem_Files(string ext , string filename , Image Icon)
        {
            InitializeComponent();
            if (ext.ToLower() == ".xls" || ext.ToLower() == ".xlsx" )
            {
                edtPic.Image = Properties.Resources.Excel32;
            }

            else if (ext.ToLower() == ".doc" || ext.ToLower() == ".docx")
            {
                edtPic.Image = Properties.Resources.Word32;
            }

            else if (ext.ToLower() == ".pdf" )
            {
                edtPic.Image = Properties.Resources.PDF32;
            }
            else
            {
                edtPic.Image = Icon;
